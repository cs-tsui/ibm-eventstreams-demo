...
public class EventStreamsConsoleSample {
    ...
    static final Map<String, Object> getConsumerConfigs(String bootstrapServers, String apikey) {
        ...
        String consumer_id = System.getenv("kafka_client_id_custom");
        if (consumer_id == null || consumer_id.equals("")) {
            consumer_id = "kafka-java-console-consumer-1";
        }

        String group_id = System.getenv("kafka_group_id_custom");
        if (group_id == null || consumer_id.equals("")) {
            group_id = "kafka-java-console-group-1";
        }
        ...
        configs.put(ConsumerConfig.AUTO_COMMIT_INTERVAL_MS_CONFIG, 500);
    ...
    static final Map<String, Object> getCommonConfigs(String boostrapServers, String apikey) {
        ...
        String certPath = System.getenv("CERT_PATH");      // src/main/resources/es-cert.jks
        // if (System.getenv("ES_CP4I") != null && !System.getenv("ES_CP4I").isEmpty()) {
            configs.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, certPath);
